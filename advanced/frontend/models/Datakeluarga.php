...
class Datakeluarga extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['nama_istri', 'tempat_menikah', 'nama_pendeta', 'no_registrasi', 'status_dalam_keluarga', 'nama_ayah', 'nama_ibu', 'jumlah_anak', 'id_datadiri'], 'required'],
            [['tanggal_pernikahan'], 'safe'],
            [['no_registrasi', 'jumlah_anak', 'id_datadiri'], 'integer'],
